      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-300 max-w-2xl mx-auto">
            We're a passionate group of developers and advocates ready to help you build amazing event-driven applications.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {teamMembers.map((member, index) => (
            <div 
              key={index}
              className="group relative overflow-hidden rounded-2xl bg-slate-800 p-6 hover:transform hover:-translate-y-2 transition-all duration-300"
            >
